<template>
  <div class="header">
    <div class="content-wrapper">
      <div class="avatar">
        <img class="logo" width="64" height="64" />
      </div>
      <div class="content">
        <div class="title">
    ...
    <div class="background">
      <img :src="seller.headerbg" width="100%" height="100%"/>
    </div>
    <transition name="fade">
      <div v-show="deatilShow" class="detail">
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .content-wrapper
    ...
    .avatar
      .logo
        background: url("logo-50.png") center center no-repeat
      img
        border-radius: 2px
    .content
      margin-left: 16px
